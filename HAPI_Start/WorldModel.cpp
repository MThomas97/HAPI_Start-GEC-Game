...
void WorldModel::Play(int width, int height, std::string name)
{
	...
	if (!visual.CreateSprite("Background", "Data\\horse.bmp"))
		return;
	...
	{	//calls functions from classes
		...
		visual.RenderNoAlphaSprite("Background", 0, 0);
		/*visual.RenderNoAlphaSprite("Background", 254, 256);
		visual.RenderNoAlphaSprite("Background", 254, 0);
		visual.RenderNoAlphaSprite("Background", 0, 256);
		visual.RenderNoAlphaSprite("Background", 508, 512);
		visual.RenderNoAlphaSprite("Background", 508, 0);
		visual.RenderNoAlphaSprite("Background", 0, 512);
		visual.RenderNoAlphaSprite("Background", 254, 512);
		visual.RenderNoAlphaSprite("Background", 508, 256);
		visual.RenderNoAlphaSprite("Background", 0, 768);
		visual.RenderNoAlphaSprite("Background", 254, 768);
		visual.RenderNoAlphaSprite("Background", 508, 768);*/
